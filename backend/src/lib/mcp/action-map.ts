...
export const COMPOSIO_ACTION_MAP: Record<string, Record<string, string[]>> = {
  ...
  'googledocs': {
    ...
    'create': ['GOOGLESUPER_CREATE_DOCUMENT'],
    'search': ['GOOGLESUPER_SEARCH_DOCUMENTS'],
    'read': ['GOOGLESUPER_GET_DOCUMENT_PLAINTEXT', 'GOOGLESUPER_SEARCH_DOCUMENTS'],
    'write': ['GOOGLESUPER_INSERT_TEXT_ACTION', 'GOOGLESUPER_CREATE_DOCUMENT'],
  },
  'googlecontacts': {
    'default': [
  ...
  'googlemaps': {
    'default': [
      'GOOGLESUPER_GEOCODE_ADDRESS',
      'GOOGLESUPER_GET_DIRECTION',
      'GOOGLESUPER_GET_ROUTE',
      'GOOGLESUPER_GET_PLACE_DETAILS'
    ],
    'search': ['GOOGLESUPER_GEOCODE_ADDRESS', 'GOOGLESUPER_GET_PLACE_DETAILS'],
    'read': ['GOOGLESUPER_GET_DIRECTION', 'GOOGLESUPER_GET_ROUTE', 'GOOGLESUPER_GET_PLACE_DETAILS'],
  },
  'googlechat': {
    'default': [
  ...
  'googleslides': {
    'default': [
      'GOOGLESUPER_CREATE_PRESENTATION',
      'GOOGLESUPER_PRESENTATIONS_GET',
      'GOOGLESUPER_PRESENTATIONS_BATCH_UPDATE'
    ],
    'create': ['GOOGLESUPER_CREATE_PRESENTATION'],
    'read': ['GOOGLESUPER_PRESENTATIONS_GET'],
    'write': ['GOOGLESUPER_PRESENTATIONS_BATCH_UPDATE', 'GOOGLESUPER_CREATE_PRESENTATION'],
  },
  'googlephotos': {
    'default': [
    ...
    'create': ['GOOGLESUPER_CREATE_ALBUM', 'GOOGLESUPER_BATCH_CREATE_MEDIA_ITEMS'],
    'search': ['GOOGLESUPER_SEARCH_MEDIA_ITEMS'],
    'read': ['GOOGLESUPER_GET_ALBUM', 'GOOGLESUPER_SEARCH_MEDIA_ITEMS'],
  },
  'googlemeet': {
    'default': [
    ...
    'create': ['GOOGLESUPER_CREATE_MEET'],
    'read': ['GOOGLESUPER_GET_MEET', 'GOOGLESUPER_GET_TRANSCRIPT'],
  },
  'googlesuper': {
    'default': [
      'GOOGLESUPER_FETCH_EMAILS',
